...
(function () {
    ...
    function _buildShapeOpts(s) {
        ...
        var isPosition = shapeName === 'long_position' || shapeName === 'short_position';
        ...
        if (isText) {
            ...
            overrides = {
                ...
                fontSize: s.fontSize || s.fontsize || 12,
                fontsize: s.fontSize || s.fontsize || 12,
            ...
            overrides = {
                ...
                fontSize: s.fontSize || s.fontsize || 14,
                fontsize: s.fontsize || s.fontSize || 14,
            };
            ...
            // long_position / short_position — 3 точки: entry, sl, tp
            // TV автоматически рисует зоны и метки Target/Stop/Closed P&L
            overrides = {
                color:           s.color || 'rgba(41,98,255,0.90)',
                linecolor:       s.color || 'rgba(41,98,255,0.90)',
                backgroundColor: s.color || 'rgba(41,98,255,0.90)',
        ...
        return {
            ...
            disableSave: true,
            disableUndo: true,
            zOrder: s.zOrder || (isText || isLabelShape ? 'top' : (isRect || isPosition ? 'bottom' : 'top')),
            overrides: overrides,
        };
    }
    ...
    var _TVE_SHAPE_TYPES = {
        ...
        // Позиции (бэктест)
        long_position: 1, short_position: 1,
    };
