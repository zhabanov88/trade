  ...
  function showTradesModal(run) {
    ...
    const exportCSV = () => {
      const COLS = ['#','entry_date','entry_time','day_of_week','exit_time','instrument','direction',
        ...
        'delta','rb_ticks','rb_open','rb_close','rb_high','rb_low',
        'gex_zero_gamma','gex_sum_vol','gex_major_neg','gex_has_data'];
      const rows = trades.map((t,i) => [
        ...
        t.rb_delta??'—', t.rb_ticks??'—', fp2(t.rb_open), fp2(t.rb_close), fp2(t.rb_high), fp2(t.rb_low),
        fp2(t.gex_zero_gamma), fp0(t.gex_sum_vol), fp0(t.gex_major_neg), t.gex_has_data??'—',
