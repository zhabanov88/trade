                    ...
                    <tbody>
                        ${intervals.map(i => `
                            <tr>
                                ...
                                <td>${escapeHtml(i.tradingview_code)}</td>
                                <td>${escapeHtml(i.clickhouse_table)}</td>
                                <td>${escapeHtml(i.seconds)}s</td>
                                <td>
                ...
                <div class="scripts-list">
                    ${scripts.length === 0 ? '<p>No scripts yet</p>' : scripts.map(script => `
                        <div class="script-card">
                            <h3>${escapeHtml(script.display_name)}</h3>
                            <p>${escapeHtml(script.description)}</p>
                            <small>System: ${escapeHtml(script.system_name)}</small>
                            <div class="actions">
